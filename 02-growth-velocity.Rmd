...
```{r , echo = FALSE}
include_graphics(paste0(fig_dir, "/manuscript-figure-composites/risk-factor/extended-data/fig-waz-vel-PAR.png"))
```
...
```{r , echo = FALSE}
include_graphics(paste0(fig_dir, "/manuscript-figure-composites/risk-factor/extended-data/fig-length-vel-PAR.png"))
```
...
```{r , echo = FALSE}
include_graphics(paste0(fig_dir, "/manuscript-figure-composites/risk-factor/extended-data/fig-weight-vel-PAR.png"))
```
